...
<header id="header" >
	...
	<footer class="footer-top">
    	<div class="container">
            ...
            <div class="col-md-4">
            	<h2 class="footer-heading">FIND US IN CITY</h2>
    ...
    <footer class="footer-bottom">
    	<div class="container">
    		<p>Copyright © By Ways 2 Home Services. Always at your door step. <span class='pull-right small'><a href='http://www.yksoftwaresolutions.com' target="_blank">Powered By: YK Software Solutions</a></span></p>
